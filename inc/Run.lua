...
kick_user(msg.sender_user_id_,msg.chat_id_)
	...
	sendMsg(Uploaded_Groups_CH,Uploaded_Groups_MS,'• 𖣔  تم رفع النسخه‏‏ الاحتياطيه\n• 𖣔  حالياً عدد مجموعاتك هيه‏ *'..redis:scard(sela..'group:ids')..' .*\n')
	end
