...
return sendMsg(msg.chat_id_,msg.id_,'\n↯ ًاهلا عزيزي البوت هنا ادمن بالقروب \n↯ وصلاحياته هي ↓ \nــــــــــــــــــــــــــــــــ𖤍𖤍𖤍ـــــــــــــــــــــــــ\n↯ تغير معلومات المجموعه ↞ ❪ '..info..' ❫\n↯ حذف الرسائل ↞𖤍 ❪ '..delete..' ❫\n↯ حظر المستخدمين ↞𖤍 ❪ '..restrict..' ❫\n↯ دعوة مستخدمين ↞𖤍 ❪ '..invite..' ❫\n↯ تثبيت الرسائل ↞𖤍 ❪ '..pin..' ❫\n↯ اضافة مشرفين جدد ↞𖤍 ❪ '..promote..' ❫\n\n↯ ملاحضه » علامة ❪  ꪜ ❫ تعني لديه الصلاحية وعلامة ❪ ✘ ❫ تعني ليس ليديه الصلاحيه')   
end
end
end
...
if redis:get(sela.."getidstatus"..msg.chat_id_) == "Photo" then
	if data.photos_[0] then 
		...
		sendPhoto(msg.chat_id_,msg.id_,data.photos_[0].sizes_[1].photo_.persistent_id_,'ꕥ 𝙽𝙰𝙼𝙴  𖢍   '..Namei..'     \n𖡗 𝚄𝚂𝙴𝚁 𖠲 '..UserNameID..' .\n𖣀 𝙼𝚂𝙶𝙴 𖣩 '..msgs..' .\n𖣐 𝚂𝚃𝙰  ❆ '..msg.TheRank..' .\n𖤏 𝙸𝙳 ࿖ '..msg.sender_user_id_..' \n⚘ 𝚌𝚑 𖠪 @TAMER_HOSNI .',dl_cb,nil)
		else
...
.."——————𖤍𖤍𖤍———————\n"
.."↯𖤍 الأسم ( "..FlterName(data.first_name_..' '..(data.last_name_ or ""),25).." )\n"
.."↯𖤍 المعرف ( "..ResolveUser(data).." )\n"
.."↯𖤍 الأيدي ( `"..msg.sender_user_id_.."` )\n"
.."↯𖤍 رتبتك ( "..msg.TheRank.." )\n"
.."↯ ـ ( `"..msg.chat_id_.."` )\n"
.."————————𖤍𖤍𖤍————————\n"
.." ↯𖤍 الأحصائيات الرسائل .\n"
.."↯𖤍 الرسائل ( `"..msgs.."` )\n"
.."↯𖤍 الجهات ( `"..NumGha.."` )\n"
.."↯𖤍 الصور ( `"..photo.."` )\n"
.."↯𖤍 المتحركه ( `"..animation.."` )\n"
.."↯𖤍 الملصقات ( `"..sticker.."` )\n"
.."↯𖤍 البصمات ( `"..voice.."` )\n"
.."↯𖤍 الصوت ( `"..audio.."` )\n"
.."↯𖤍 الفيديو ( `"..video.."` )\n"
...
local Get_info ="↯𖤍 أهلاً عزيزي تم مسح جميع معلوماتك "
return sendMsg(msg.chat_id_,msg.id_,Get_info)    
end,nil)
return false
end
...
if not msg.Admin then return "↯𖤍هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not MsgText[2] and msg.reply_id then 
...
if not msg.Creator then return "↯𖤍هذا الامر يخص {المطور,المنشئ} فقط  \n" end
...
if not msg.SudoBase then return"↯𖤍هذا الامر يخص {المطور الاساسي} فقط  \n" end
local mtwren = redis:scard(sela..':SUDO_BOT:')
if mtwren == 0 then  return "↯𖤍 عذراً لا يوجد مطورين في البوت ." end
redis:del(sela..':SUDO_BOT:') 
return "↯𖤍 تم مسح {* "..mtwren.." *} من المطورين .\n"
end
...
if addbannds ==0 then 
return "*↯𖤍 قائمة الحظر فارغه .*" 
end
redis:del(sela..'gban_users') 
return "↯𖤍 تـم مـسـح { *"..addbannds.." *} من قائمه العام\n" 
end 
...
if GroupDel == 0 then
sendMsg(msg.chat_id_,msg.id_,'↯𖤍 جـيـد , لا توجد مجموعات وهميه \n')
else
sendMsg(msg.chat_id_,msg.id_,'↯𖤍 عدد المجموعات ↯⊱ { *'..#groups..'*  } ⊰↯\n↯𖤍 تـم تنظيف  ↯⊱ { *'..GroupDel..'*  } ⊰↯ مجموعه \n↯𖤍 اصبح العدد الحقيقي الان ↯⊱ { *'..GroupsIsFound..'*  } ⊰↯ مجموعه')
end
end
end)
end
...
sendMsg(msg.chat_id_,msg.id_,'↯𖤍 عدد المشتركين ↯⊱ { *'..#pv..'*  } ⊰↯\n↯𖤍 تـم تنظيف  ↯⊱ { *'..NumPvDel..'*  } ⊰↯ مشترك \n↯𖤍 اصبح العدد الحقيقي الان ↯⊱ { *'..SenderOk..'*  } ⊰↯ من المشتركين') 
end
end
end)
end)
...
return '↯𖤍 تم وضـع شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..MsgText[2]..'】* عضـو  .\n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'↯𖤍 شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..redis:get(sela..':addnumberusers')..'】* عضـو .\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات" then
if not msg.SudoUser then return "↯𖤍هذا الامر يخص {المطور} فقط  \n" end
...
if not msg.SudoBase then return "↯𖤍هذا الامر يخص {المطور} فقط  \n" end
...
sendMsg(MsgText[2],0,'↯𖤍 تم تعطيل المجموعه بأمر من المطور  \n↯𖤍 سوف اغادر ...\n✘')
rem_data_group(MsgText[2])
StatusLeft(MsgText[2],our_id)
return '↯𖤍 تم تعطيل المجموعه ومغادرتها \n↯ المجموعة » ['..name_gp..']\n↯𖤍 الايدي » ( *'..MsgText[2]..'* )\n'
else 
return '↯𖤍 لا توجد مجموعه مفعله بهذا الايدي .\n ' 
end 
end 
...
return "↯𖤍 الاذاعه مقفوله من قبل المطور الاساسي  ." 
end
redis:setex(sela..'fwd:'..msg.sender_user_id_,300, true) 
return "↯𖤍 حسننا الان ارسل التوجيه للاذاعه \n" 
end
...
return "↯𖤍 حسننا الان ارسل الكليشه للاذاعه عام \n" 
end
...
return "↯𖤍 حسننا الان ارسل الكليشه للاذاعه خاص \n"
end
...
return "↯𖤍 حسننا الان ارسل الكليشه للاذاعه للمجموعات \n" 
end
...
return "↯𖤍هذا الامر يخص {المطور الاساسي} فقط  \n" 
end
...
if not msg.SudoBase then return"↯𖤍 *│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
...
sendMsg(msg.chat_id_,msg.id_,'↯𖤍 جارٍ رفع النسخه انتظر قليلا ... \n')
end
end,nil)
else 
sendMsg(msg.chat_id_,msg.id_,"↯𖤍 عذراً النسخه الاحتياطيه هذا ليست للبوت » ["..Bot_User.."]  \n")
end
else 
sendMsg(msg.chat_id_,msg.id_,'↯𖤍 عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس سيلا يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
sendMsg(msg.chat_id_,msg.id_,'↯𖤍 عذراً الملف ليس بصيغه Json !?\n')
end 
else
sendMsg(msg.chat_id_,msg.id_,'↯𖤍 عذراً هذا ليس ملف النسحه الاحتياطيه للمجموعات\n')
end 
end,nil)
else 
...
if (MsgText[1]== "ايدي" or MsgText[1]=="ايديي𖤍") and msg.type == "pv" then return  "\n↯ اهلاً عزيزي المطور ايديك :\n\n↯ "..msg.sender_user_id_.."\n"  end
...
if not msg.SudoBase then return"↯𖤍هذا الامر يخص {المطور الاساسي} فقط  \n" end
return '↯𖤍 الاحصائيات . \n\n↯𖤍عدد المجموعات المفعله : '..redis:scard(sela..'group:ids')..'\n↯عدد المشتركين في البوت : '..redis:scard(sela..'users')..'\n'
end
---------------[End Function data] -----------------------
...
return "↯𖤍 تم مسح كل الردود ."
else
return '↯𖤍 لا يوجد ردود ليتم مسحها \n'
end
end

if MsgText[1]== 'مسح' and MsgText[2]== 'الردود العامه' then
if not msg.SudoBase then return"↯𖤍 للمطورين فقط ." end
...
return "↯𖤍 تم مسح كل الردود العامه ."
else
return "↯𖤍 لا يوجد ردود عامه ليتم مسحها ."
end
end
...
return '↯𖤍لا يوجد ردود مضافه حاليا \n' 
end
local ii = 1
local message = '↯𖤍ردود البوت في المجموعه  :\n\n'
...
if not msg.SudoBase then return "↯𖤍 للمطور فقط ." end
...
local ii = 1
local message = '↯𖤍الردود العامه في البوت :   :\n\n'
for i=1, #photo 	do message = message ..ii..' - *{* '..	photo[i]..' *}_*( صوره ) \n' 	ii = ii + 1 end
for i=1, #names 	do message = message ..ii..' - *{* '..	names[i]..' *}_*( نص ) \n'  	ii = ii + 1 end
for i=1, #voice 	do message = message ..ii..' - *{* '..	voice[i]..' *}_*( بصمه ) \n' 	ii = ii + 1 end
for i=1, #imation 	do message = message ..ii..' - *{* '..imation[i]..' *}_*( متحركه ) \n'ii = ii + 1 end
...
❀↞❬أوامر المسح❭
———————𝐒𝐸𝐿𝐴—————
𖤍↯مسح الادمنـيـه «» ❬لمسح الادمنيه❭
𖤍↯مسح المميزين «» ❬لمسح المميزين❭
𖤍↯ مسح المــــدراء «» ❬لمسح المدراء❭
———————𝐒𝐸𝐿𝐴—————
❀↞❬أوامر الحظر والطرد والتقييد❭
———————𝐒𝐸𝐿𝐴—————
𖤍↯ حظر ❬بالرد «» بالمعرف❭ لحظر العضو.
𖤍↯ الغاء الحظر ❬بالرد «» بالمعرف❭ لإلغاء الحظر. 
𖤍↯ طرد ❬بالرد «» بالمعرف❭ لطرد العضو.
𖤍↯ كتم ❬بالرد «» بالمعرف❭ لكتم العضو. 
𖤍↯ الغاء الكتم ❬بالرد«»بالمعرف❭لإلغاء الكتم. 
𖤍↯ تقييد ❬بالرد «» بالمعرف❭ لتقييد العضو.
𖤍↯ فك التقييد ❬بالرد «» بالمعرف❭ لإلغاء تقييد العضو.
𖤍↯ منع + الكلمة «» لمنع كلمة داخل المجموعة.
𖤍↯ الغاء منع «» لالغاء منع الكلمة.
——————𖤍𝐒𝐸𝐿𝐴𖤍——————
هلا عزيزي "..msg.TheRankCmd.."\n↯ المغادره بالتاكيد تم تفعيلها\n✓" 
else 
...
❀︎︎︎︎ 𝐒𝑂𝑈𝑅𝐶𝐸  𝐒𝐸𝐿𝐴 シ      
 ≪━━━━𑁍𝐒𝐸𝐿𝐴𑁍━━━━≫
★↯ -[𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑❶𖤍](t.me/IE_S9)

★↯ -[𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑❷𖤍](t.me/O_7_w)

★↯ -[𝐈𝐍𝐅𝐎𝐑𝐌𝐀𝐓𝐈𝐎𝐍𖤍](t.me/Xb_1b)

★↯ -[𝐂𝐇𝐀𝐍𝐍𝐄𝐋 𝐙𝐎𝐑𝐎𖤍](t.me/TAMER_HOSNI) 

★↯ -[𝐓𝐎 𝐓𝐀𝑳𝐊 𝐔𝐒 𖤍](t.me/Tawaslsourceselabot)
]]
end
...
return '↯𖤍عدد سحكاتك ⇜ ❪ '..(redis:get(sela..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n'
end
...
if SubDel == 1 then
return "↯𖤍 تم تعطيل الاشتراك الاجباري . \n✓"
else
return "↯𖤍 الاشتراك الاجباري بالفعل معطل . \n✓"
end
end
...
return "↯𖤍 لا يوجد قناة مفعله على الاشتراك الاجباري . \n"
end
end
...
if not msg.Kara then return "↯𖤍هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط ." end

function setadmins(black,diamond)

if msg.can_promote_members == false then

sendMsg(msg.chat_id_,msg.id_,'↯𖤍 البوت لايمتلك  صلاحية رفع مشرف')
...
sendMsg(msg.chat_id_,msg.id_,'↯𖤍 الأسم : ['..data.first_name_..'](tg://user?id='..diamond.sender_user_id_..')\n↯ تم رفعه مشرف بكامل الصلاحيات\n‏‏')
...
if not msg.Kara then return "↯𖤍هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local cmd = Black:match('تغير امر (.*)') 
redis:setex(sela..'addcmd'..msg.chat_id_..msg.sender_user_id_,120,cmd)
sendMsg(msg.chat_id_,msg.id_,'↯𖤍 اهلا بك عزيزي\n↯ الامر الي تريد تغيره الي  "'..cmd..'" \n↯ ارسله الان\n')
end
...
sendMsg(msg.chat_id_,msg.id_,"↯𖤍 اهلا عزيزي\nالامر >"..cmd.."\n↯ تم مسحه من قائمه الاوامر\n")
end
...
sendMsg(msg.chat_id_,msg.id_,"↯𖤍 اهلا عزيزي تم مسح قائمه الاوامر")
end
...
𖤍↯ أختصاصي حماية المجموعات ..
𖤍↯ مـن السبام والتوجيه والتكرار والخ..
𖤍↯ لتفعيل البوت اتبع الشـروط ..
𖤍1- اضف البوت الى المجموعه
𖤍2- ارفع البوت مشرف في المجموعه
𖤍3- ارسل تفعيل وسيتم تفعيل البوت ورفع مشرفي القررب تلقائياً .

ــــــــــــــــــــــــــــــــ𖤍𝐒𝐸𝐿𝐴𖤍ـــــــــــــــــــــــــ
...
𖤍1- اضف البوت الى المجموعه
𖤍2- ارفع البوت مشرف في المجموعه
𖤍③- ارسل تفعيل وسيتم تفعيل البوت ورفع مشرفي القررب تلقائياً .
...
sendMsg(msg.chat_id_,msg.id_,"↯𖤍 تم آرسـآل رسالتك إلى المطور\n↯ سـآرد عليك في اقرب وقت ممكن \n↯ معرف المطور "..SUDO_USER)
...
elseif Text== "اوامر التسليه"  then return sendMsg(msg.chat_id_,msg.id_,"\n‌‌‏ٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬\nٴ𐄬 مرحباً عزيزي\nٴ𐄬 هذي اوامر التسليه:  \nٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬\nٴ𐄬 رفع › تنزيل ❬ متوحد ❭\nٴ𐄬 رفع › تنزيل ❬ وتكه ❭\nٴ𐄬 رفع › تنزيل ❬ غبي ❭\nٴ𐄬 رفع › تنزيل ❬ كلب ❭\nٴ𐄬 رفع › تنزيل ❬ حمار ❭\nٴ𐄬 رفع › تنزيل ❬ زوجتي ❭\nٴ𐄬 رفع › تنزيل ❬ متوحده ❭\nٴ𐄬 رفع › ❬ بقلبي ❭ تنزيل › ❬ من قلبي❭\nٴ𐄬 ❬ طلاق ❭ › ❬ زواج ❭\nٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬")
 ...
 elseif Text== "ايديي" or Text=="ايدي ☆" then 
  ...
  if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
  local USERCAR = utf8.len(USERNAME)
  SendMention(msg.chat_id_,data.id_,msg.id_,"• اضغط على الايدي ليتم النسخخ\n\n "..USERNAME.." ~⪼ ( "..data.id_.." )",37,USERCAR)  
  return false
  end)
...
❆رابط حذف [Snspchat](https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount) ܁
  ...
  --=====================================
  elseif Text== "يوسف" or Text== " فارس " or Text=="basel abaza" then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[مطور السورس.](https://t.me/xb_1b) ")
