...
return sendMsg(msg.chat_id_,msg.id_,'\n± ًاهلا عزيزي البوت هنا ادمن بالقروب \n± وصلاحياته هي ↓ \nــــــــــــــــــــــــــــــــꕤꕤꕤـــــــــــــــــــــــــ\n± تغير معلومات المجموعه ↞ ❪ '..info..' ❫\n± حذف الرسائل ↞ꕤ ❪ '..delete..' ❫\n± حظر المستخدمين ↞ꕤ ❪ '..restrict..' ❫\n± دعوة مستخدمين ↞ꕤ ❪ '..invite..' ❫\n± تثبيت الرسائل ↞ꕤ ❪ '..pin..' ❫\n± اضافة مشرفين جدد ↞ꕤ ❪ '..promote..' ❫\n\n± ملاحضه » علامة ❪  ꪜ ❫ تعني لديه الصلاحية وعلامة ❪ ✘ ❫ تعني ليس ليديه الصلاحيه')   
end
end
end
...
if redis:get(Sela.."getidstatus"..msg.chat_id_) == "Photo" then
	if data.photos_[0] then 
		...
		sendPhoto(msg.chat_id_,msg.id_,data.photos_[0].sizes_[1].photo_.persistent_id_,'𖡗 𝙽𝙰𝙼𝙴  ⚘   '..Namei..'     \n↯ 𝚄𝚂𝙴𝚁 ⚘ '..UserNameID..' .\n𖡗 𝙼𝚂𝙶𝙴 ⚘ '..msgs..' .\n↯ 𝚂𝚃𝙰  ⚘ '..msg.TheRank..' .\n𖤏 𝙸𝙳 ࿖ '..msg.sender_user_id_..' \n⚘ 𝚌𝚑 𖠪 @teamsela .',dl_cb,nil)
		else
...
.."——————ꕤꕤꕤ———————\n"
.."±ꕤ الأسم ( "..FlterName(data.first_name_..' '..(data.last_name_ or ""),25).." )\n"
.."±ꕤ المعرف ( "..ResolveUser(data).." )\n"
.."±ꕤ الأيدي ( `"..msg.sender_user_id_.."` )\n"
.."±ꕤ رتبتك ( "..msg.TheRank.." )\n"
.."± ـ ( `"..msg.chat_id_.."` )\n"
.."————————ꕤꕤꕤ————————\n"
.." ±ꕤ الأحصائيات الرسائل .\n"
.."±ꕤ الرسائل ( `"..msgs.."` )\n"
.."±ꕤ الجهات ( `"..NumGha.."` )\n"
.."±ꕤ الصور ( `"..photo.."` )\n"
.."±ꕤ المتحركه ( `"..animation.."` )\n"
.."±ꕤ الملصقات ( `"..sticker.."` )\n"
.."±ꕤ البصمات ( `"..voice.."` )\n"
.."±ꕤ الصوت ( `"..audio.."` )\n"
.."±ꕤ الفيديو ( `"..video.."` )\n"
...
local Get_info ="±ꕤ أهلاً عزيزي تم مسح جميع معلوماتك "
return sendMsg(msg.chat_id_,msg.id_,Get_info)    
end,nil)
return false
end
...
if MsgText[2] == "ال" 	then return unlock_ID(msg) end
...
if not msg.Admin then return "±ꕤهذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not MsgText[2] and msg.reply_id then 
...
if not msg.Creator then return "±ꕤهذا الامر يخص {المطور,المنشئ} فقط  \n" end
...
if not msg.SudoBase then return"±ꕤهذا الامر يخص {المطور الاساسي} فقط  \n" end
local mtwren = redis:scard(Sela..':SUDO_BOT:')
if mtwren == 0 then  return "±ꕤ عذراً لا يوجد مطورين في البوت ." end
redis:del(Sela..':SUDO_BOT:') 
return "±ꕤ تم مسح {* "..mtwren.." *} من المطورين .\n"
end
...
if addbannds ==0 then 
return "*±ꕤ قائمة الحظر فارغه .*" 
end
redis:del(Sela..'gban_users') 
return "±ꕤ تـم مـسـح { *"..addbannds.." *} من قائمه العام\n" 
end 
...
if GroupDel == 0 then
sendMsg(msg.chat_id_,msg.id_,'±ꕤ جـيـد , لا توجد مجموعات وهميه \n')
else
sendMsg(msg.chat_id_,msg.id_,'±ꕤ عدد المجموعات ±⊱ { *'..#groups..'*  } ⊰±\n±ꕤ تـم تنظيف  ±⊱ { *'..GroupDel..'*  } ⊰± مجموعه \n±ꕤ اصبح العدد الحقيقي الان ±⊱ { *'..GroupsIsFound..'*  } ⊰± مجموعه')
end
end
end)
end
...
sendMsg(msg.chat_id_,msg.id_,'±ꕤ عدد المشتركين ±⊱ { *'..#pv..'*  } ⊰±\n±ꕤ تـم تنظيف  ±⊱ { *'..NumPvDel..'*  } ⊰± مشترك \n±ꕤ اصبح العدد الحقيقي الان ±⊱ { *'..SenderOk..'*  } ⊰± من المشتركين') 
end
end
end)
end)
...
return '±ꕤ تم وضـع شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..MsgText[2]..'】* عضـو  .\n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'±ꕤ شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..redis:get(Sela..':addnumberusers')..'】* عضـو .\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات" then
if not msg.SudoUser then return "±ꕤهذا الامر يخص {المطور} فقط  \n" end
...
if not msg.SudoBase then return "±ꕤهذا الامر يخص {المطور} فقط  \n" end
...
sendMsg(MsgText[2],0,'±ꕤ تم تعطيل المجموعه بأمر من المطور  \n±ꕤ سوف اغادر ...\n✘')
rem_data_group(MsgText[2])
StatusLeft(MsgText[2],our_id)
return '±ꕤ تم تعطيل المجموعه ومغادرتها \n± المجموعة » ['..name_gp..']\n±ꕤ الايدي » ( *'..MsgText[2]..'* )\n'
else 
return '±ꕤ لا توجد مجموعه مفعله بهذا الايدي .\n ' 
end 
end 
...
return "±ꕤ الاذاعه مقفوله من قبل المطور الاساسي  ." 
end
redis:setex(Sela..'fwd:'..msg.sender_user_id_,300, true) 
return "±ꕤ حسننا الان ارسل التوجيه للاذاعه \n" 
end
...
return "±ꕤ حسننا الان ارسل الكليشه للاذاعه عام \n" 
end
...
return "±ꕤ حسننا الان ارسل الكليشه للاذاعه خاص \n"
end
...
return "±ꕤ حسننا الان ارسل الكليشه للاذاعه للمجموعات \n" 
end
...
return "±ꕤهذا الامر يخص {المطور الاساسي} فقط  \n" 
end
...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/abazaa/SelaFILE/master/GetVersion.txt' ) or 0
...
return 'ٴ࿗ اصدار سورس سيلا : *v'..version..'* \n'
end



if MsgText[1] == 'نسخه احتياطيه للمجموعات' then
if not msg.SudoBase then return"±ꕤ *│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
...
sendMsg(msg.chat_id_,msg.id_,'±ꕤ جارٍ رفع النسخه انتظر قليلا ... \n')
end
end,nil)
else 
sendMsg(msg.chat_id_,msg.id_,"±ꕤ عذراً النسخه الاحتياطيه هذا ليست للبوت » ["..Bot_User.."]  \n")
end
else 
sendMsg(msg.chat_id_,msg.id_,'±ꕤ عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس سيلا يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
sendMsg(msg.chat_id_,msg.id_,'±ꕤ عذراً الملف ليس بصيغه Json !?\n')
end 
else
sendMsg(msg.chat_id_,msg.id_,'±ꕤ عذراً هذا ليس ملف النسحه الاحتياطيه للمجموعات\n')
end 
end,nil)
else 
...
return "±ꕤ تم مسح كل الردود ."
else
return '±ꕤ لا يوجد ردود ليتم مسحها \n'
end
end

if MsgText[1]== 'مسح' and MsgText[2]== 'الردود العامه' then
if not msg.SudoBase then return"±ꕤ للمطورين فقط ." end
...
return "±ꕤ تم مسح كل الردود العامه ."
else
return "±ꕤ لا يوجد ردود عامه ليتم مسحها ."
end
end
...
return '±ꕤلا يوجد ردود مضافه حاليا \n' 
end
local ii = 1
local message = '±ꕤردود البوت في المجموعه  :\n\n'
...
if not msg.SudoBase then return "±ꕤ للمطور فقط ." end
...
local ii = 1
local message = '±ꕤالردود العامه في البوت :   :\n\n'
for i=1, #photo 	do message = message ..ii..' - *{* '..	photo[i]..' *}_*( صوره ) \n' 	ii = ii + 1 end
for i=1, #names 	do message = message ..ii..' - *{* '..	names[i]..' *}_*( نص ) \n'  	ii = ii + 1 end
for i=1, #voice 	do message = message ..ii..' - *{* '..	voice[i]..' *}_*( بصمه ) \n' 	ii = ii + 1 end
for i=1, #imation 	do message = message ..ii..' - *{* '..imation[i]..' *}_*( متحركه ) \n'ii = ii + 1 end
...
❀↞❬أوامر المسح❭
———————𝐒𝐸𝐿𝐴—————
ꕤ±مسح الادمنـيـه «» ❬لمسح الادمنيه❭
ꕤ±مسح المميزين «» ❬لمسح المميزين❭
ꕤ± مسح المــــدراء «» ❬لمسح المدراء❭
———————𝐒𝐸𝐿𝐴—————
❀↞❬أوامر الحظر والطرد والتقييد❭
———————𝐒𝐸𝐿𝐴—————
ꕤ± حظر ❬بالرد «» بالمعرف❭ لحظر العضو.
ꕤ± الغاء الحظر ❬بالرد «» بالمعرف❭ لإلغاء الحظر. 
ꕤ± طرد ❬بالرد «» بالمعرف❭ لطرد العضو.
ꕤ± كتم ❬بالرد «» بالمعرف❭ لكتم العضو. 
ꕤ± الغاء الكتم ❬بالرد«»بالمعرف❭لإلغاء الكتم. 
ꕤ± تقييد ❬بالرد «» بالمعرف❭ لتقييد العضو.
ꕤ± فك التقييد ❬بالرد «» بالمعرف❭ لإلغاء تقييد العضو.
ꕤ± منع + الكلمة «» لمنع كلمة داخل المجموعة.
ꕤ± الغاء منع «» لالغاء منع الكلمة.
——————ꕤ𝐒𝐸𝐿𝐴ꕤ——————
...
❀-❬أوامر الإعدادات❭
——————ꕤ𝐒𝐸𝐿𝐴ꕤ——————
ꕤ
���𝐇𝐀𝐍𝐍𝐄𝐋 𝐒𝐸𝐿𝐴](t.me/teamsela) 

★± -[𝐓𝐎 𝐓𝐀𝑳𝐊 𝐔𝐒 ꕤ](t.me/Tawaslsourceselabot)
]]
end
...
return '±ꕤعدد سحكاتك ⇜ ❪ '..(redis:get(Sela..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n'
end
...
if SubDel == 1 then
return "±ꕤ تم تعطيل الاشتراك الاجباري . \n✓"
else
return "±ꕤ الاشتراك الاجباري بالفعل معطل . \n✓"
end
end
...
return "±ꕤ لا يوجد قناة مفعله على الاشتراك الاجباري . \n"
end
end
...
if not msg.Kara then return "±ꕤهذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط ." end

function setadmins(black,diamond)

if msg.can_promote_members == false then

sendMsg(msg.chat_id_,msg.id_,'±ꕤ البوت لايمتلك  صلاحية رفع مشرف')
...
sendMsg(msg.chat_id_,msg.id_,'±ꕤ الأسم : ['..data.first_name_..'](tg://user?id='..diamond.sender_user_id_..')\n± تم رفعه مشرف بكامل الصلاحيات\n‏‏')
...
if not msg.Kara then return "±ꕤهذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local cmd = Black:match('تغير امر (.*)') 
redis:setex(Sela..'addcmd'..msg.chat_id_..msg.sender_user_id_,120,cmd)
sendMsg(msg.chat_id_,msg.id_,'±ꕤ اهلا بك عزيزي\n± الامر الي تريد تغيره الي  "'..cmd..'" \n± ارسله الان\n')
end
...
sendMsg(msg.chat_id_,msg.id_,"±ꕤ اهلا عزيزي\nالامر >"..cmd.."\n± تم مسحه من قائمه الاوامر\n")
end
...
ꕤ± أختصاصي حماية المجموعات ..
ꕤ± مـن السبام والتوجيه والتكرار والخ..
ꕤ± لتفعيل البوت اتبع الشـروط ..
ꕤ1- اضف البوت الى المجموعه
ꕤ2- ارفع البوت مشرف في المجموعه
ꕤ3- ارسل تفعيل وسيتم تفعيل البوت ورفع مشرفي القررب تلقائياً .

ــــــــــــــــــــــــــــــــꕤ𝐒𝐸𝐿𝐴ꕤـــــــــــــــــــــــــ
...
ꕤ1- اضف البوت الى المجموعه
ꕤ2- ارفع البوت مشرف في المجموعه
ꕤ③- ارسل تفعيل وسيتم تفعيل البوت ورفع مشرفي القررب تلقائياً .

ـــــــــــــــــــــــــــــــــ𝐒𝐸𝐿𝐴ــــــــــــــــــــــــ
 ± مـعـرف الـمـطـــور : ]]..SUDO_USER..[[
]]
end
...
sendMsg(msg.chat_id_,msg.id_,"±ꕤ تم آرسـآل رسالتك إلى المطور\n± سـآرد عليك في اقرب وقت ممكن \n± معرف المطور "..SUDO_USER)
...
elseif Text== "ملك التلجرام" or Text== "مطور السورس" then return  sendMsg(msg.chat_id_,msg.id_,"[باسل ⚡](https://t.me/xb_0b)")
...
elseif Text== "اوامر التسليه"  then return sendMsg(msg.chat_id_,msg.id_,"\n‌‌‏ٴ࿗ٴ࿗ٴ࿗ٴ࿗ٴ࿗\nٴ࿗ مرحباً عزيزي\nٴ࿗ هذي اوامر التسليه:  \nٴ࿗ٴ࿗ٴ࿗ٴ࿗ٴ࿗\nٴ࿗ رفع › تنزيل ❬ متوحد ❭\nٴ࿗ رفع › تنزيل ❬ وتكه ❭\nٴ࿗ رفع › تنزيل ❬ غبي ❭\nٴ࿗ رفع › تنزيل ❬ كلب ❭\nٴ࿗ رفع › تنزيل ❬ حمار ❭\nٴ࿗ رفع › تنزيل ❬ زوجتي ❭\nٴ࿗ رفع › تنزيل ❬ متوحده ❭\nٴ࿗ رفع › ❬ بقلبي ❭ تنزيل › ❬ من قلبي❭\nٴ࿗ ❬ طلاق ❭ › ❬ زواج ❭\nٴ࿗ٴ࿗ٴ࿗ٴ࿗ٴ࿗")
  ...
  elseif Text== "ايديي" or Text=="ايديي" then 
  GetUserID(msg.sender_user_id_,function(arg,data)
  if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
  local USERCAR = utf8.len(USERNAME)
  ...
  elseif Text=="رابط فارس" or Text=="ابي رابط حذف" or Text=="رابط حذف" or Text=="رابط الحذف" then
  return sendMsg(msg.chat_id_,msg.id_,[[
...
❆رابط حذف [Snspchat](https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount) ܁
  ...
  --=====================================
  elseif Text== "فيرو" or Text== " فارس " or Text=="فارس" then
...
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[انت مطوري الغالي ♕](https://t.me/teamsela) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه  تاج راسي♔](https://t.me/teamsela)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت مدير المجموعه๑](https://t.me/teamsela)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت ادمن شد حيلك♘](https://t.me/teamsela)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[مجرد عضو هنا 𖦹](https://t.me/teamsela)")
end 
end 

elseif Text== "مين ضافني" or Text== "منو ضافني"  then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[انت مكانك كل مكان يا مطور♕](https://t.me/teamsela) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه](https://t.me/teamsela)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/teamsela)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/teamsela)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/teamsela)")
