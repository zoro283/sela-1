...
if redis:get(sela..'group:add'..msg.chat_id_) then  return '• 𖣔 المجموعة تم تفعيلها مُسبقاً . ' end
...
if not redis:get(sela..'group:add'..msg.chat_id_) then return '𖣔  المجموعه تم تعطيلها مُسبقاً .' end  
...
if cmd == "dn_sudo" then
if not redis:sismember(sela..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'• 𖣔 العضو » '..USERNAME..' \n• 𖣔  الايدي » (`'..UserID..'`)\n• 𖣔 انه بالتأكيد ليس مطور \n') end
redis:srem(sela..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم تنزيله من المطور \n',17,USERCAR) 
end
