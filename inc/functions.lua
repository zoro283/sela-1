...
─────▀██▀─────
│𝐒𝐸𝐿𝐴 ‿ @IE_S9
تم تطوير وبرمجة السورس من قبل فارس وندا ☆
│@IE_S9 ☆‿☆  @O_7_w
-------------------------------------------------------------------
]]
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(herwen..":NameBot:")
...
var = ' المنشىء الاساسي' 
elseif redis:sismember(herwen..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء' 
elseif redis:sismember(herwen..'owners:'..ChatID,UserID) then
var = 'مدير البوت' 
elseif redis:sismember(herwen..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت' 
elseif redis:sismember(herwen..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز' 
else
var = 'فقط عضو' 
end
...
if msg.edited then
redis:incr(herwen..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(herwen..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(herwen..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(herwen..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(herwen..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(herwen..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(herwen..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(herwen..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(herwen..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(herwen..':SUDO_BOT:')
message = '• 𖣔  قائمه الـمـطـوريـن : \n\n`• مطور اساسي`𖣔 \n'..SUDO_USER..' » ❪' ..SUDO_ID.. '❫\n*———————————————— *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n .*"
else
for k,v in pairs(list) do
local info = redis:hgetall(herwen..'username:'..v)
local count = redis:scard(herwen..'mtwr_count'..v)
...
local monsha = redis:smembers(herwen..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————— \n\n• قائمه المدراء :*\n\n'
local list = redis:smembers(herwen..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(herwen..'admins:'..msg.chat_id_)
if #list==0 then  return  "• 𖣔  لا يوجد ادمن في هذه المجموعه \n" end
...
local list = redis:smembers(herwen..'whitelist:'..msg.chat_id_)
if #list == 0 then return "*• لا يوجد مميزين في القائمه *" end
message = '• 𖣔  قائمه الاعضاء المميزين :\n'   
for k,v in pairs(list) do
local info = redis:hgetall(herwen..'username:'..v)
if info and info.username and info.username:match("@[%a%d_]+") then
message = message ..k.. '~⪼ '..(info.username or '')..' » ❪`' ..v.. '`❫ \n'
...
if redis:sismember(herwen..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(herwen..'is_silent_users:'..msg.chat_id_)
if #list==0 then return "• 𖣔 لايوجد اعضاء مكتومين " end
message = '• 𖣔 قائمه الاعضاء المكتومين :\n'
for k,v in pairs(list) do
local info = redis:hgetall(herwen..'username:'..v)
if info and info.username and info.username:match("@[%a%d_]+") then
message = message ..k.. '~⪼ '..(info.username or '')..' » ❪`' ..v.. '`❫ \n'
...
if redis:sismember(herwen..'banned:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(herwen..'banned:'..msg.chat_id_)
if #list==0 then return "• 𖣔 لايوجد أعضاء محظورين " end
message = '• 𖣔 قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
local info = redis:hgetall(herwen..'username:'..v)
if info and info.username and info.username:match("@[%a%d_]+") then
message = message ..k.. '~⪼ '..(info.username or '')..' » ❪`' ..v.. '`❫ \n'
...
if redis:sismember(herwen..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(herwen..'gban_users')
if #list==0 then return  "*• لايوجد اعضاء محظورين عام*" end
message = '• 𖣔 قائمه المحظورين عام :\n'
for k,v in pairs(list) do
local info = redis:hgetall(herwen..'username:'..v)
if info and info.username and info.username:match("@[%a%d_]+") then
message = message ..k.. '~⪼ '..(info.username or '')..' » ❪`' ..v.. '`❫ \n'
...
local list = redis:smembers(herwen..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
local list = redis:smembers(herwen..':Filter_Word:'..msg.chat_id_)
if #list == 0 then return "• 𖣔 قائمه الكلمات الممنوعه فارغه" end
filterlist = '• 𖣔 قائمه الكلمات الممنوعه :\n'    
for k,v in pairs(list) do
...
if redis:sismember(herwen..':Filter_Word:'..msg.chat_id_,word) then 
return  "• 𖣔 الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع ." 
else
redis:sadd(herwen..':Filter_Word:'..msg.chat_id_,word) 
return  "• 𖣔 الكلمه *{"..word.."}* تمت اضافتها الى قائمه المنع ."
end
end

function RemFilter(msg, word)
if redis:sismember(herwen..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(herwen..':Filter_Word:'..msg.chat_id_,word) 
return  "• 𖣔 الكلمه *{"..word.."}* تم السماح بها .️" 
else
return  "• 𖣔 الكلمه *{"..word.."}* هي بالتأكيد مسموح بها ." 
end
end
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(herwen..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(herwen..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(herwen..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(herwen..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
json_data = '{"BotID": '..herwen..',"UserBot": "'..Bot_User..'","Groups" : {'
local All_Groups_ID = redis:smembers(herwen..'group:ids')
for key,GroupS in pairs(All_Groups_ID) do
local NameGroup = (redis:get(herwen..'group:name'..GroupS) or '')
...
local admins = redis:smembers(herwen..'admins:'..GroupS)
if #admins ~= 0 then
json_data =  json_data..',"Admins" : {'
for key,value in pairs(admins) do
local info = redis:hgetall(herwen..'username:'..value)
if info then 
...
local creators = redis:smembers(herwen..':MONSHA_BOT:'..GroupS)
if #creators ~= 0 then
...
local creator = redis:smembers(herwen..':KARA_BOT:'..GroupS)
if #creator ~= 0 then
...
local owner = redis:smembers(herwen..'owners:'..GroupS)
if #owner ~= 0 then
...
local list = redis:smembers(herwen..'group:ids')
message = '• 𖣔 قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(herwen..'group:name'..v)
if info then 
...
sendMsg(msg.chat_id_,1,'• 𖣔 عذرا لديك الكثير من المجموعات\n• 𖣔 سوف ارسل لك ملف فيها قائمه مجموعات المفعله انتظر لحظه ...')
...
redis:del(
herwen..'group:add'..id_group,
herwen..'lock_link'..id_group, 
herwen..'lock_id'..id_group,
herwen..'lock_spam'..id_group, 
herwen..'lock_webpage'..id_group,
herwen..'lock_markdown'..id_group,
herwen..'lock_flood'..id_group,
herwen..'lock_bots'..id_group,
herwen..'mute_forward'..id_group,
herwen..'mute_contact'..id_group,
herwen..'mute_location'..id_group,
herwen..'mute_document'..id_group,
herwen..'mute_keyboard'..id_group,
herwen..'mute_game'..id_group,
herwen..'mute_inline'..id_group,
herwen..'lock_username'..id_group,
herwen..'num_msg_herwen'..id_group,
herwen..'replay'..id_group
)
redis:srem(herwen..'group:ids',id_group)
end
...
redis:hset(herwen..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(herwen..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
function modadd(msg)
if redis:get(herwen..'lock_service') then
service = true
Get_Director = 30
else
service = false
...
if redis:get(herwen..'group:add'..msg.chat_id_) then  return '• 𖣔 المجموعة تم تفعيلها مُسبقاً . ' end

local UserChaneel = redis:get(herwen..":UserNameChaneel")
...
redis:setex(herwen..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(herwen..':addnumberusers') or 0)
...
return sendMsg(msg.chat_id_,msg.id_,'• 𖣔 عذرا البوت ليس ادمن  في المجموعه\n• 𖣔 يرجى ترقيته ادمن لتتمكن من تفعيل البوت .')
else
local lock_service = redis:get(herwen..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(herwen..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(herwen..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
herwen..'group:add'..msg.chat_id_,true,
herwen..'lock_link'..msg.chat_id_,true, 
herwen..'lock_id'..msg.chat_id_,true,
herwen..'lock_spam'..msg.chat_id_,true,
herwen..'lock_webpage'..msg.chat_id_,true,
herwen..'lock_markdown'..msg.chat_id_,true,
herwen..'lock_flood'..msg.chat_id_,true,
herwen..'lock_bots'..msg.chat_id_,true,
herwen..'mute_forward'..msg.chat_id_,true,
herwen..'mute_contact'..msg.chat_id_,true,
herwen..'mute_location'..msg.chat_id_,true,
herwen..'mute_document'..msg.chat_id_,true,
herwen..'mute_keyboard'..msg.chat_id_,true,
herwen..'mute_game'..msg.chat_id_,true,
herwen..'mute_inline'..msg.chat_id_,true,
herwen..'lock_username'..msg.chat_id_,true,
herwen..'num_msg_herwen'..msg.chat_id_,5, 
herwen..'replay'..msg.chat_id_,true
)

redis:sadd(herwen..'group:ids',msg.chat_id_) 
redis:sadd(herwen..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(herwen..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(herwen..'linkGroup'..msg.chat_id_,Gp_Link)
if not we_sudo(msg) then
GetUserID(msg.sender_user_id_,function(arg,datai)
if datai.username_ then 
USERNAME_T = '• 𖣔 الـمعرف ❪ @['..datai.username_..'] ❫\n'
else 
USERNAME_T = ''
end
return send_msg(SUDO_ID,'• 𖣔  تــــم تــفــعــيــل الـــبـــوت ...\n———————————————\n• معلومات المجموعه\n'
..'• اسم المجموعه ❪ ['..NameGroup..']('..Gp_Link..') ❫\n'
..'• ايدي المجموعه ❪ '..msg.chat_id_..' ❫\n'
..'• عدد اعضاء المجموعه ❪ *'..Groupcount..'* ❫\n———————————————\n• معلومات الشخص الي ضافني \n'
..'• 𖣔 الاسـم ❪ ['..FlterName(datai.first_name_..' '..(datai.last_name_ or ""),23)..'](tg://user?id='..msg.sender_user_id_..') ❫\n'
...
function modrem(msg)
if not msg.SudoUser then return '• 𖣔  أنـت لـسـت الـمـطـور .'end
if not redis:get(herwen..'group:add'..msg.chat_id_) then return '𖣔  المجموعه تم تعطيلها مُسبقاً .' end  
rem_data_group(msg.chat_id_)
return '• 𖣔  تـم تـعـطـيـل الـمـجـمـوعـه .'
end
...
if cmd =="tqeed" then
if UserID == our_id then   
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك تقييد البوت\n") 
elseif UserID == SUDO_ID then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك تقييد المطور الاساسي\n") 
elseif UserID == 1014436808 then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك تقييد مطور السورس\n") 
elseif UserID == 656329268 then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك تقييد مطور السورس\n") 
elseif UserID == 1059262308 then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك تقييد مطور السورس\n") 
elseif redis:sismember(herwen..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك تقييد المطور\n") 
elseif redis:sismember(herwen..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك تقييد المنشئ\n") 
elseif redis:sismember(herwen..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك تقييد المدير\n") 
elseif redis:sismember(herwen..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك تقييد الادمن\n") 
end
...
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنني تقييد المشرف\n") 
end
end)
end
...
if cmd =="fktqeed" then
if UserID == our_id then  
return sendMsg(ChatID,MsgID,"• 𖣔 البوت ليس مقييد  \n") 
end
...
if UserID == our_id then 
return sendMsg(ChatID,MsgID,"• 𖣔 عذرا لا يمكنني رفع نفسي \n") 
elseif data.type_.ID  == "UserTypeBot" then 
return sendMsg(ChatID,MsgID,"• 𖣔 عذرا لا يمكن رفع بوت في البوت \n") 
elseif data.type_.ID == "chatTypeChannel" then 
return sendMsg(ChatID,MsgID,"• 𖣔 عذرا لا يمكن رفع قناة في البوت \n") 
end
if redis:sismember(herwen..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(herwen..'username:'..UserID,'username',Resolv)
redis:sadd(herwen..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تمت ترقيته ليصبح منشىء \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(herwen..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(herwen..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(herwen..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(herwen..'username:'..UserID,'username',Resolv)
redis:sadd(herwen..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تمت ترقيته ليصبح منشىء اساسي \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(herwen..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(herwen..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(herwen..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(herwen..'username:'..UserID, 'username', Resolv)
redis:sadd(herwen..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(herwen..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(herwen..'whitelist:'..ChatID,UserID)
...
if redis:sismember(herwen..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(herwen..'username:'..UserID, 'username', Resolv)
redis:sadd(herwen..'owners:'..ChatID,UserID)
...
if redis:sismember(herwen..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(herwen..'username:'..UserID, 'username', Resolv)
redis:sadd(herwen..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(herwen..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(herwen..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(herwen..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(herwen..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(herwen..'msgs:'..UserID..':'..ChatID) or 1
...
if cmd == "ban" then
if UserID == our_id then   
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك حظر البوت\n") 
elseif UserID == SUDO_ID then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك حظر المطور الاساسي\n") 
elseif UserID == 1014436808 then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك حظر مطور السورس\n") 
elseif UserID == 656329268 then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك حظر مطور السورس\n") 
elseif UserID == 1059262308 then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك حظر مطور السورس\n") 
elseif redis:sismember(herwen..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك حظر المطور\n") 
elseif redis:sismember(herwen..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك حظر المنشئ\n") 
elseif redis:sismember(herwen..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك حظر المدير\n") 
elseif redis:sismember(herwen..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك حظر الادمن\n") 
end
kick_user(UserID,ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
return sendMsg(ChatID,MsgID,'• 𖣔 لا يمكنني حظر العضو .\n• 𖣔 لانه مشرف في المجموعه \n .')    
elseif data.ID == "Error" and data.code_ == 3 then
return sendMsg(ChatID,MsgID,'• 𖣔 لا يمكنني حظر العضو .\n• 𖣔 ليس لدي صلاحيه الحظر او لست مشرف\n .')    
else
redis:hset(herwen..'username:'..UserID, 'username', Resolv)
redis:sadd(herwen..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم حظره  \n',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(herwen..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم بالتأكيد الغاء حظره  \n',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم الغاء حظره \n',17,USERCAR) 
end
redis:srem(herwen..'banned:'..ChatID,UserID)
StatusLeft(ChatID,UserID)
end

if cmd == "silent" then
if UserID == our_id then   
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك كتم البوت\n") 
elseif UserID == SUDO_ID then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك كتم المطور الاساسي\n• ") 
elseif UserID == 1014436808 then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك كتم مطور السورس\n") 
elseif UserID == 656329268 then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك كتم مطور السورس\n") 
elseif UserID == 1059262308 then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك كتم مطور السورس\n") 
elseif redis:sismember(herwen..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك كتم المطور\n") 
elseif redis:sismember(herwen..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك كتم المنشئ\n") 
elseif redis:sismember(herwen..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك كتم المدير\n") 
elseif redis:sismember(herwen..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك كتم الادمن\n") 
end
if redis:sismember(herwen..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم بالتأكيد كتمه  \n',17,USERCAR) 
end
redis:hset(herwen..'username:'..UserID, 'username', Resolv)
redis:sadd(herwen..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم كتمه \n',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(herwen..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم بالتاكيد الغاء كتمه  \n',17,USERCAR) 
end
redis:srem(herwen..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم الغاء كتمه  \n',17,USERCAR) 
end
...
if GeneralBanned(UserID) then return sendMsg(ChatID,MsgID,'• 𖣔  العضو » ❪ '..USERNAME..' ❫\n• 𖣔 الايدي » ❪ `'..UserID..'` ❫\n• 𖣔 تم بالتأكيد حظره عام \n') end
redis:hset(herwen..'username:'..UserID, 'username',Resolv)
redis:sadd(herwen..'gban_users',UserID)
...
redis:srem(herwen..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم الغاء حظره العام \n',17,USERCAR) 
end

if cmd == "kick" then
if UserID == our_id then   
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك طرد البوت\n") 
elseif UserID == SUDO_ID then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك طرد المطور الاساسي\n") 
elseif UserID == 1014436808 then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك طرد مطور السورس\n") 
elseif UserID == 656329268 then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك طرد مطور السورس\n") 
elseif UserID == 1059262308 then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك طرد مطور السورس\n") 
elseif redis:sismember(herwen..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك طرد المطور\n") 
elseif redis:sismember(herwen..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(herwen..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك طرد المدير\n") 
elseif redis:sismember(herwen..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك طرد الادمن\n") 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
return sendMsg(ChatID,MsgID,'• 𖣔  لا يمكنني حظر العضو .\n• 𖣔 لانه مشرف في المجموعه \n .')    
...
if redis:sismember(herwen..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد مطور \n',17,USERCAR) 
end
redis:hset(herwen..'username:'..UserID, 'username', Resolv)
redis:sadd(herwen..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم ترقيته ليصبح مطور \n',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(herwen..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس مطور \n',17,USERCAR) 
end
redis:srem(herwen..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم تنزيله من المطور \n',17,USERCAR) 
end  -- End Cmd 
end,nil)
else
return sendMsg(ChatID,MsgID,"• 𖣔  عذرا هذا العضو ليس موجود ضمن المجموعات \n .")
end 
end
...
if data.status_.ID == "ChatMemberStatusMember" then 
Restrict(ChatID,UserID,1)  
return sendMsg(ChatID,MsgID,'• 𖣔 العضو » ❪ '..UserName..' ❫\n• 𖣔 الايدي » ❪ `'..UserID..'` ❫\n• 𖣔 تم تقييد آلعضـو بنجاح \n') 
else
return sendMsg(ChatID,MsgID,'• 𖣔 لا يمكنني تقييد العضو .\n• 𖣔 لانه مشرف في المجموعه \n .')    
end
end)
else
return sendMsg(ChatID,MsgID,'• 𖣔 لا يمكنني تقييد العضو .\n• 𖣔 لانني لست مشرف في المجموعه \n')    
end
end)
...
if data.status_.ID == "ChatMemberStatusEditor" then 
Restrict(ChatID,UserID,2)
return sendMsg(ChatID,MsgID,'• 𖣔 العضو » ❪ '..UserName..' ❫\n• 𖣔 الايدي » ❪ `'..UserID..'` ❫\n• 𖣔 تم فك تقييد آلعضـو بنجآح \n') 
else
return sendMsg(ChatID,MsgID,'• 𖣔 لا يمكنني قك تقييد العضو .\n• 𖣔 لانني لست مشرف في المجموعه \n')    
end
end)
end,nil)
end
...
if redis:sismember(herwen..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'• 𖣔 العضو » ❪ '..UserName..' ❫\n• 𖣔 الايدي » ❪ `'..UserID..'` ❫\n• 𖣔 انه بالتأكيد منشىء في البوت \n') 
end
redis:hset(herwen..'username:'..UserID, 'username', UserName)
redis:sadd(herwen..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,'• 𖣔 العضو » ❪ '..UserName..' ❫\n• 𖣔 الايدي » ❪ `'..UserID..'` ❫\n• 𖣔 تمت ترقيته ليصبح منشى في البوت \n')
end

if cmd == "remmnsha" then
if not redis:sismember(herwen..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'• 𖣔 العضو » ❪ '..UserName..' ❫\n• 𖣔 الايدي » ❪ `'..UserID..'` ❫\n• 𖣔 انه بالتأكيد ليس منشى \n') 
end
redis:srem(herwen..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,'• 𖣔 العضو » ❪ '..UserName..' ❫\n• 𖣔 الايدي » ❪ `'..UserID..'` ❫\n• 𖣔 تمت تنزيله من المنشىء \n') 
end
...
if redis:sismember(herwen..'whitelist:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'• 𖣔 العضو » ❪ '..UserName..' ❫\n• 𖣔 الايدي » ❪ `'..UserID..'` ❫\n• 𖣔 انه بالتأكيد من عضو مميز \n') 
end
redis:hset(herwen..'username:'..UserID, 'username', UserName)
redis:sadd(herwen..'whitelist:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,'• 𖣔 العضو » ❪ '..UserName..' ❫\n• 𖣔 الايدي » ❪ `'..UserID..'` ❫\n• 𖣔 تمت ترقيته ليصبح ضمن عضو مميز \n')
end

if cmd == "remwhitelist" then
if not redis:sismember(herwen..'whitelist:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'• 𖣔 العضو » ❪ '..UserName..' ❫\n• 𖣔 الايدي » ❪ `'..UserID..'` ❫\n• 𖣔 انه بالتأكيد ليس من عضو مميز \n') 
end
redis:srem(herwen..'whitelist:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,'• 𖣔 العضو » ❪ '..UserName..' ❫\n• 𖣔 الايدي » ❪ `'..UserID..'` ❫\n• 𖣔 تمت تنزيله من عضو مميز \n')
end
...
redis:hset(herwen..'username:'..UserID, 'username', UserName)
redis:sadd(herwen..'admins:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,'• 𖣔 العضو » ❪ '..UserName..' ❫\n• 𖣔 الايدي » ❪ `'..UserID..'` ❫\n𖣔 تمت ترقيته ليصبح ادمن \n')
end

if cmd == "remowner" then
if not redis:sismember(herwen..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'• 𖣔 العضو » ❪ '..UserName..' ❫\n• 𖣔 الايدي » ❪ `'..UserID..'` ❫\n• 𖣔 انه بالتأكيد ليس مدير \n') 
end
redis:srem(herwen..'owners:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,'• 𖣔 العضو » ❪ '..UserName..' ❫\n• 𖣔 الايدي » ❪ `'..UserID..'` ❫\n• 𖣔 تم تنزيله من الاداره \n')
end

if cmd == "demote" then
if not redis:sismember(herwen..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'• 𖣔 العضو » ❪ '..UserName..' ❫\n• 𖣔 الايدي » ❪ `'..UserID..'` ❫\n• 𖣔 انه بالتأكيد ليس ادمن \n') 
end
redis:srem(herwen..'admins:'..ChatID,UserID)
...
if cmd == "iduser" then
return sendMsg(ChatID,MsgID,"• 𖣔  أضغط على الايدي ليتم النسخ\n\n "..UserName.." ~⪼ ( `"..UserID.."` )")
end

if cmd == "whois" then
return sendMsg(ChatID,MsgID,
  '• 𖣔  الاسم » '..FlterName(data.title_,30)..'\n'
..'• 𖣔  الايدي » {`'..UserID..'`} \n'
..'• 𖣔  المعرف » '..UserName..'\n'
..'• 𖣔  نوع الكشف » بالمعرف\n'
..'')
...
if UserID == our_id then 
return sendMsg(ChatID,MsgID,"• 𖣔 عذرا لا يمكنني حظر نفسي \n") 
elseif data.type_.ID == "ChannelChatInfo" then 
return sendMsg(ChatID,MsgID,"• 𖣔 عذرا لا يمكن حظر قناة \n") 
end
if redis:sismember(herwen..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'• 𖣔 العضو » ❪ '..UserName..' ❫\n• 𖣔 الايدي » ❪ `'..UserID..'` ❫\n• 𖣔 تم بالتأكيد حظره \n') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
if cmd == "unban" then
if not redis:sismember(herwen..'banned:'..ChatID,UserID) then 
sendMsg(ChatID,MsgID,'• 𖣔 العضو » ❪ '..UserName..' ❫\n• 𖣔 الايدي » ❪ `'..UserID..'` ❫\n• 𖣔 تم بالتأكيد الغاء حظره \n') 
else
sendMsg(ChatID,MsgID,'• 𖣔 العضو » ❪ '..UserName..' ❫\n• 𖣔 الايدي » ❪ `'..UserID..'` ❫\n• 𖣔 تم الغاء حظره \n')
end
redis:srem(herwen..'banned:'..ChatID,UserID)
...
if cmd == "unbanall" then
if not GeneralBanned(UserID) then 
return sendMsg(ChatID,MsgID,'• 𖣔 العضو » ❪ '..UserName..' ❫\n• 𖣔 الايدي » ❪ `'..UserID..'` ❫\n• 𖣔 م بالتأكيد الغاء حظره العام \n') 
end
redis:srem(herwen..'gban_users',UserID)
return sendMsg(ChatID,MsgID,'• 𖣔 العضو » ❪ '..UserName..' ❫\n• 𖣔 الايدي » ❪ `'..UserID..'` ❫\n• 𖣔 تم الغاء حظره العام \n')
end
...
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك طرد المطور\n") 
elseif
redis:sismember(herwen..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(herwen..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك طرد المدير\n") 
elseif redis:sismember(herwen..'admins:'..ChatID,UserID) then 
...
kick_user(UserID,ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
return sendMsg(ChatID,MsgID,'• 𖣔  لا يمكنني طرد العضو .\n• 𖣔 لانه مشرف في المجموعه \n')    
elseif data.ID == "Error" and data.code_ == 3 then
return sendMsg(ChatID,MsgID,'• 𖣔  لا يمكنني طرد العضو .\n• 𖣔 ليس لدي صلاحيه الحظر او لست مشرف\n')    
end
redis:hset(herwen..'username:'..UserID, 'username', UserName)
...
redis:hset(herwen..'username:'..UserID, 'username', UserName)
redis:sadd(herwen..':SUDO_BOT:',UserID)
return sendMsg(ChatID,MsgID,'• 𖣔 العضو » ❪ '..UserName..' ❫\n• 𖣔 الايدي » ❪ `'..UserID..'` ❫\n• 𖣔 تم ترقيته ليصبح مطور \n')
end

if cmd == "dn_sudo" then
if not redis:sismember(herwen..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,'• 𖣔 العضو » ❪ '..UserName..' ❫\n• 𖣔 الايدي » ❪ `'..UserID..'` ❫\n• 𖣔 نه بالتأكيد ليس مطور \n')
end
redis:srem(herwen..':SUDO_BOT:',UserID)
return sendMsg(ChatID,MsgID,'• 𖣔 العضو » ❪ '..UserName..' ❫\n• 𖣔 الايدي » ❪ `'..UserID..'` ❫\n• 𖣔 تم تنزيله من المطور \n') 
end

else
return sendMsg(ChatID,MsgID,"• 𖣔  لا يوجد عضـو بهذا المعرف \n")
end 
...
sendMsg(ChatID,MsgID,"• 𖣔  العضو لا يوجد\n") 
return false
end
local UserID = data.id_
local Resolv = ResolveUser(data)
...
Restrict(ChatID,UserID,1)
redis:hset(herwen..'username:'..UserID, 'username', Resolv)
redis:sadd(herwen..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم تقييد آلعضـو بنجاح \n',17,USERCAR) 
end 
if cmd =="fktqeed" then
  Restrict(ChatID,UserID,2)
  redis:srem(herwen..':tqeed:'..ChatID,UserID)
...
if cmd == "dn_sudo" then
if not redis:sismember(herwen..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'• 𖣔 العضو » '..USERNAME..' \n• 𖣔  الايدي » (`'..UserID..'`)\n• 𖣔 انه بالتأكيد ليس مطور \n') end
redis:srem(herwen..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم تنزيله من المطور \n',17,USERCAR) 
end
...
if redis:sismember(herwen..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"• 𖣔 لا يمكنك كتم المدراء او الادمنيه\n") 
end
...
if redis:get(herwen..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(herwen..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(herwen..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(herwen..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*•*` اعدادات المجموعه :` \n"
.."\n• التعديل «» "..(redis:get(herwen..'lock_edit'..msg.chat_id_) or 'false')
.."\n• الروابط «» "..(redis:get(herwen..'lock_link'..msg.chat_id_) or 'false')
.."\n• التاك «» "..(redis:get(herwen..'lock_tag'..msg.chat_id_) or 'false')
.."\n• المعرفات «» "..(redis:get(herwen..'lock_username'..msg.chat_id_) or 'false')
.."\n• التكرار «» "..(redis:get(herwen..'lock_flood'..msg.chat_id_) or 'false')
.."\n• الكلايش «» "..(redis:get(herwen..'lock_spam'..msg.chat_id_) or 'false')
.."\n• الويب «» "..(redis:get(herwen..'lock_webpage'..msg.chat_id_) or 'false')
.."\n• الماركدوان «» "..(redis:get(herwen..'lock_markdown'..msg.chat_id_) or 'false')
.."\n• بالطرد البوتات «» "..(redis:get(herwen..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n• البوتات «» "..(redis:get(herwen..'lock_bots'..msg.chat_id_) or 'false')
.."\n• عدد التكرار «» "..(redis:get(herwen..'num_msg_herwen'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n•`اعدادات الوسائط :`\n"
.."\n*• *المتحركه «» "..(redis:get(herwen..'mute_gif'..msg.chat_id_) or 'false')
.."\n• الدردشه «» "..(redis:get(herwen..'mute_text'..msg.chat_id_) or 'false')
.."\n• الانلاين «» "..(redis:get(herwen..'mute_inline'..msg.chat_id_) or 'false')
.."\n• الالعاب «» "..(redis:get(herwen..'mute_game'..msg.chat_id_) or 'false')
.."\n• الصور «» "..(redis:get(herwen..'mute_photo'..msg.chat_id_) or 'false')
.."\n• الفيديو «» "..(redis:get(herwen..'mute_video'..msg.chat_id_) or 'false')
.."\n• البصمات «» "..(redis:get(herwen..'mute_audio'..msg.chat_id_) or 'false')
.."\n• الصوت «» "..(redis:get(herwen..'mute_voice'..msg.chat_id_) or 'false')
.."\n• الملصقات «» "..(redis:get(herwen..'mute_sticker'..msg.chat_id_) or 'false')
.."\n• الجهات «» "..(redis:get(herwen..'mute_contact'..msg.chat_id_) or 'false')
.."\n• التوجيه «» "..(redis:get(herwen..'mute_forward'..msg.chat_id_) or 'false')
.."\n• الموقع «» "..(redis:get(herwen..'mute_location'..msg.chat_id_) or 'false')
.."\n• الملفات «» "..(redis:get(herwen..'mute_document'..msg.chat_id_) or 'false')
.."\n• الاشعارات «» "..(redis:get(herwen..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n• الكيبورد «» "..(redis:get(herwen..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*•*`اعدادات اخرى : `"
.."\n\n*•*الترحيب «» "..welcomex
.."\n*•*الردود «» "..replayx
...
.."\n*•*الويب «» "..(redis:get(herwen..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*•*الماركدوان «» "..(redis:get(herwen..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*•*البوتات بالطرد «» "..(redis:get(herwen..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*•*البوتات «» "..(redis:get(herwen..'lock_bots'..msg.chat_id_) or 'false')
.."\n*•*عدد التكرار «» "..(redis:get(herwen..'num_msg_herwen'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*•*اعدادات التقـييد :\n"
.."\n*•*التقييد بالتوجيه «» "..(redis:get(herwen..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*•*التقييد بالصور «» "..(redis:get(herwen..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*•*التقييد بالروابط «» "..(redis:get(herwen..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*•*التقييد بالمتحركه «» "..(redis:get(herwen..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*•*التقييد الفيديو «» "..(redis:get(herwen..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
