...
sendMsg(msg.chat_id_,msg.id_,"❀| حسننا , الان يمكنك ارسال الاسم شكرا لستخدامك سورس سيلا اكتب الرموز لعرض الرموز  ☆")    
return false
end
...
.."`\n\n9- `"..Zhrf9..Emoje[math.random(#Emoje)]
.."`\n\n10- `"..Zhrf5..Emoje[math.random(#Emoje)]
Text_Zhrfa = Text_Zhrfa.."`\n\n✎| اضغط علي الاسم ليتم النسخ شكرا لستخدامك سورس سيلا اكتب الرموز لعرض الرموز \n✓"
sendMsg(msg.chat_id_,msg.id_,Text_Zhrfa)
return false
end
